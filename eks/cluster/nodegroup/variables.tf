variable "cluster_name" {
  ...
  validation {
    condition     = length(var.cluster_name) > 20 && length(var.cluster_name) < 64
    error_message = "Length of the name of the cluster shoud be from 20 characters to 64 characters."
  }
}
